import {
  ...
  export interface FortunaMockTetherInterface extends utils.Interface {
    functions: {
  ...
  export interface FortunaMockTether extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
  
    interface: FortunaMockTetherInterface;
